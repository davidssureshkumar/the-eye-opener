...
export const CONTROL_HELP: Record<string, ControlHelp> = {
  ...
  'channel.lossy.z0': {
    label: 'Line impedance',
    unit: 'ohm',
    what: 'Characteristic impedance of the line at the reference frequency, where it is sqrt(L/C) with conductor loss left out.',
  ...
  'channel.lossy.dielectricLossEnabled': {
    ...
    unit: '',
    what: 'Includes the loss tangent through a causal wideband Debye permittivity. Off, the dielectric is the lossless constant Dk.',
    why: 'Switching one mechanism off at a time is how an insertion-loss curve is taken apart: dielectric loss grows linearly with frequency, conductor loss with its square root.',
    see: ['dielectric-loss', 'loss-tangent', 'dispersion'],
  },
  'channel.lossy.conductorLossEnabled': {
    label: 'Conductor loss',
    unit: '',
    what: 'Includes the resistance of the copper: its DC value, rising into the skin effect, with the roughness correction below.',
    why: 'Conductor loss dominates short, narrow traces and the low-frequency end of the curve. Turning it off shows how much of the loss the laminate alone is responsible for.',
    see: ['skin-effect', 'rlgc', 'insertion-loss'],
  },
  ...
  'channel.lossy.thickness': {
    ...
    unit: 'm',
    what: 'Conductor thickness. With width and conductivity it sets the DC resistance, and the frequency at which the skin depth becomes thinner than the copper.',
    why: 'Below that onset, current fills the whole cross-section and resistance is flat; above it, resistance grows as the square root of frequency. 35 um is the thickness of 1 oz foil.',
    see: ['skin-effect', 'rlgc'],
  },
  'channel.lossy.roughnessEnabled': {
    label: 'Roughness correction',
    unit: '',
    what: 'Raises the skin-effect resistance by a roughness factor from the model selected below, applied in its causal form: the same loss, with the extra internal inductance that loss has to come with.',
    why: 'Turning it off and on separates how much of the measured loss is surface profile and how much is bulk conductor and dielectric. The causal form also makes rough copper slightly slower, which a real factor would miss.',
    see: ['roughness', 'skin-effect', 'insertion-loss'],
  },
  'channel.lossy.roughnessModel': {
    label: 'Roughness model',
    unit: '',
    what: 'Hammerstad scales loss by up to 2 from one RMS height. Huray models the foil as spheres on a flat plane and scales loss by up to 1 plus the surface ratio.',
    why: 'Hammerstad was fitted to profiles much smaller than modern treated foils and saturates too early for them. Huray keeps rising, which is closer to what very rough copper measures at high frequency.',
    see: ['roughness', 'skin-effect'],
  },
  'channel.lossy.roughnessRms': {
    label: 'Copper roughness',
    unit: 'm',
    what: 'RMS surface profile of the copper foil, for the Hammerstad model. Very-low-profile foil is a fraction of a micrometre; standard foil is a few micrometres.',
  ...
  'channel.lossy.hurayRadius': {
    label: 'Snowball radius',
    unit: 'm',
    what: 'Radius of the spheres in the Huray model. Where the skin depth equals this radius, the factor has made 40% of its full rise.',
    why: 'It sets where on the frequency axis roughness turns on. Fitted values for real foils are fractions of a micrometre, and they come from a measurement, not from the foil name.',
    see: ['roughness', 'skin-effect'],
    illustrative: true,
  },
  'channel.lossy.hurayRatio': {
    label: 'Surface ratio',
    unit: '1',
    what: 'Total sphere surface over the flat area it sits on, in the Huray model. Loss tends to 1 plus this ratio at high frequency.',
    why: 'It sets how much roughness costs at the top of the band. A ratio above 1 is how Huray predicts more than the doubling Hammerstad allows.',
    see: ['roughness', 'insertion-loss'],
    illustrative: true,
  },
